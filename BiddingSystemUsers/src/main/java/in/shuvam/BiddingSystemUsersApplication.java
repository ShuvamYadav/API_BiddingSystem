...
@EnableSwagger2
public class BiddingSystemUsersApplication {

	public static void main(String[] args) {
		SpringApplication.run(BiddingSystemUsersApplication.class, args);
	}
	@Bean
	...
	private ApiInfo apiDetails() {
		return new ApiInfo(
				"Bidding System API",
				"REST API endpoints to sign up and manage users",
				"0.0.1",
				"Open Source",
